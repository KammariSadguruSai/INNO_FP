...
GEMINI_API_KEY = "AIzaSyBLlqhxWW1Bav8XqbvTwPFSGEwaoC1rASg"  # Replace with your valid API key
...
# Sidebar for navigation and details
with st.sidebar:
    if st.button("🔗 About Developer"):
        st.subheader("")
        st.markdown("""
        **Name:** Kammari Sadguru Sai  
        **GitHub:** [github.com/KammariSadguruSai](https://github.com/KammariSadguruSaiv)  
        **LinkedIn:** [linkedin.com/in/kammarisadgurusai](https://www.linkedin.com/in/kammarisadgurusai)  
        **Instagram:** [instagram.com/imsadguru.in](https://www.instagram.com/imsadguru.in)  
        **Website:** [Portfolio](https://portfolio-sadguru.glitch.me)  
